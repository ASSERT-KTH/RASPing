...
def run_gp(
    ...
    while num_attempted < budget:
        ...
        generation += 1
        logger.info(
            f"Generation {generation} start: attempts={num_attempted}/{budget}, successful={num_evaluated}, dup={num_duplicates}, fails={num_compile_failures}"
        )
