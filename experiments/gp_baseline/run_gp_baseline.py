...
def main():
    parser = argparse.ArgumentParser(
        description="Run GP baseline to repair buggy RASP programs"
    )
    parser.add_argument(
        "--mutation-path",
        type=str,
    ...
    parser.add_argument(
        ...
        type=int,
        default=500,
        help="Max successful compile+eval candidates per bug",
    )
    parser.add_argument(
        "--population-size",
        type=int,
        default=16,
        help="Population size μ and offspring λ per generation",
    )
    parser.add_argument(
        "--tournament-k",
        type=int,
    ...
    parser.add_argument(
        ...
        type=int,
        default=25,
        help="Log progress every N successful evals",
    )
    parser.add_argument(
