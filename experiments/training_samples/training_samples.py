...
@click.option(
    "--n_samples",
    type=int,
    help="The number of samples to generate for training/validation",
)
def run_test(model_name, n_samples):
    ...
    metrics, validation = test_n_samples_function(
        model_name, n_samples, output_dir=f"saved_data/{model_name}/{n_samples}/"
    )
